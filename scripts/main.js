...
function hidemodal02() {
  ...
  setTimeout(function () {
    $('#modal02_1').addClass('visible');
    $('.sweet-overlay').css('display', 'block');
    setTimeout(function () {
      $('#success02_1').addClass('animate');
      $('#successtip02_1').addClass('animateSuccessTip');
      $('#successlong02_1').addClass('animateSuccessLong');
    }, 500);
  }, 7700);
}

function hidemodal02_1() {
  $('#modal02_1').removeClass('visible');
  $('.sweet-overlay').css('display', 'none');
  $('#spinBG').addClass('spinAround2_1');
  setTimeout(function () {
